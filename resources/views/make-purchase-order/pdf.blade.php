    ...
    <table>
        <tbody>
            <tr>
                ...
                <td style="width: 15%; font-size: 15px;">SUB TOTAL</td>
            ...
            @if($charges)    
                <tr>
                    <td colspan="3" style="width: 50%;">&nbsp;</td>
                    <td colspan="1" style="width: 10%;">&nbsp;</td>
                    <td style="width: 15%; font-size: 15px; white-space: nowrap;">{{$charges['other_charge_label']}}</td>
                ...
                @if ($charges['is_taxable'])
                    <tr style="color: rgb(172, 171, 171)">
                        <td colspan="3" style="width: 50%;">&nbsp;</td>
                        <td colspan="1" style="width: 10%;">&nbsp;</td>
                        <td style="width: 15%; font-size: 15px;">({{$charges['gst_percentage']}}%)</td>
    ...
    <table class="table-footer">
        <tbody>
            <tr>
                <td colspan="3" style="width: 50%;">&nbsp;</td>
                <td colspan="1" style="width: 10%;">&nbsp;</td>
                <td class="bordered" style="width: 15%; font-size: 15px; white-space: nowrap;">GRAND TOTAL</td>
