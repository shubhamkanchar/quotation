                ...
                <div class="card-header rounded-0 border-bottom-0 bg-secondary-subtle">
                    <div class="d-flex justify-content-between">
                        <div class="text-secondary ms-2">
                            ...
                            <br>
                            <input type="date" class="form-control" id="PurchaseOrderDate" wire:model="purchase_order_date">   
                        </div>
                        <div class="text-secondary ms-2">
                            <span >Purchase Order No</span>
                            <br>
                            PO-{{$savedPurchaseOrder?->purchase_order_no}}
                        </div>
                    </div>
                </div>
                <div class="card-body">
                        ...
                        <div class="row mb-0">
                            <div class="card-header bg-dark rounded-pill">
                                <div class="d-flex justify-content-between">
                                    ...
                                    <div class="d-flex">
                                        <button class="rounded-pill btn bg-white py-2 px-4 mx-2" type="button" wire:click="updatePurchaseOrder">Update</button>
