...
class DeliveryNoteDataTable extends DataTable
{
    ...
    public function dataTable(QueryBuilder $query): EloquentDataTable
    {
        ...
        ->addColumn('action', function($row){
            return '<a href="'.route('make-delivery-note.edit',$row->id).'" class="btn btn-primary me-2" >Edit</a><button class="btn btn-danger delete-delivery-note" data-id="'.$row->id.'">Delete</button>';
        })
        ->setRowId('id');
    }
